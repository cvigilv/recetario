#!/usr/bin/env python3
#title           :prepare_ckr.py
#description     :Calculate Klethora-Roth count molecular descriptor
#author          :Carlos Vigil Vásquez
#date            :20220511
#version         :20220511a
#notes           :Requires padeldescriptor & pandas
...
SMILES = sys.argv[1]
KR = SMILES.replace("SMILES", "DS").replace("smi", "ckr.txt")
...
padeldescriptor(
    ...
    descriptortypes="/tmp/padeldescriptor.xml",
    d_2d=False,
    d_3d=False,
    fingerprints=True,
    headless=True,
